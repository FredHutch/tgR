...
#' or just unique to your data access group (such as molecular_id, subject_id, biospecimen_id, or assay_material_id).
#' The function will return only those identifiers in your array that are valid for use.
...
#' @return Returns any identifiers supplied that are NOT already used, thus are valid for use.
...
#' @export
validIdentifiers <- function(x, type = "molecular_id", DAG = NULL) {
